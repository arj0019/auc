...
{'program': {'functions': {'function': {'type': 'int',
                           ...
                           'functions': {'function': {'type': 'int',
                                                      'identifier': 'mul_symbol_expression',
                                                      'routine': {'expression': {'type': 'int',
                                                                                 'identifier': 'a',
                                                                                 'op': '=',
                                                                                 'expression': {'value': '0'}},
                                         ...
                                         'functions': {'function': {'type': 'int',
                                                                    'identifier': 'mul_symbol_constant',
                                                                    'routine': {'expression': {'type': 'int',
                                                                                               'identifier': 'a',
                                                                                               'op': '=',
                                                                                               'expression': {'value': '0'}},
                                                                                'routine': {'expression': {'type': 'int',
                                                                                            ...
                                                                                            'routine': {'return': {'expression': {'identifier': 'b'}}}}}},
                                                       'functions': {'function': {'type': 'int',
                                                                                  'identifier': 'mul_constant_symbol',
                                                                                  'routine': {'expression': {'type': 'int',
                                                                                                             'identifier': 'a',
                                                                                                             'op': '=',
                                                                                                             'expression': {'value': '0'}},
                                                                                              'routine': {'expression': {'type': 'int',
                                                                                                          ...
                                                                                                          'routine': {'return': {'expression': {'identifier': 'b'}}}}}},
                                                                     'functions': {'function': {'type': 'int',
                                                                                                'identifier': 'mul_constant_expression',
                                                                                                'routine': {'expression': {'type': 'int',
                                                                                                                           'identifier': 'a',
                                                                                                                           'op': '=',
                                                                                                                           'expression': {'value': '0',
                                                                                   ...
                                                                                   'functions': {'function': {'type': 'int',
                                                                                                              'identifier': 'mul_constant_constant',
                                                                                                              'routine': {'return': {'expression': {'value': '0',
                                                                                                                                                    'op': '*',
                                                                                                                                                    'expression': {'value': '1'}}}}}}}}}}}}}
――― Internal Representation ――――――――――――――――――――――――――――――――――――――――――――――――――――
[[{'LOC': {'tgt': '*mul_symbol_symbol'}},
  [{'MOV': {'tgt': '*a', 'src': '#0'}},
   [{'MOV': {'tgt': '*b', 'src': '#1'}},
    [{'MOV': {'tgt': '*c', 'src': {'MUL': {'tgt': '*a', 'src': '*b'}}}},
     {'RET': {'tgt': '*c'}}]]]],
 [[{'LOC': {'tgt': '*mul_symbol_expression'}},
   [{'MOV': {'tgt': '*a', 'src': '#0'}},
    [{'MOV': {'tgt': '*b',
              'src': {'MUL': {'tgt': '*a',
                              'src': {'MUL': {'tgt': '#1', 'src': '#2'}}}}}},
     {'RET': {'tgt': '*b'}}]]],
  [[{'LOC': {'tgt': '*mul_symbol_constant'}},
    [{'MOV': {'tgt': '*a', 'src': '#0'}},
     [{'MOV': {'tgt': '*b', 'src': {'MUL': {'tgt': '*a', 'src': '#1'}}}},
      {'RET': {'tgt': '*b'}}]]],
   [[{'LOC': {'tgt': '*mul_constant_symbol'}},
     [{'MOV': {'tgt': '*a', 'src': '#0'}},
      [{'MOV': {'tgt': '*b', 'src': {'MUL': {'tgt': '#1', 'src': '*a'}}}},
       {'RET': {'tgt': '*b'}}]]],
    [[{'LOC': {'tgt': '*mul_constant_expression'}},
      [{'MOV': {'tgt': '*a',
                'src': {'MUL': {'tgt': '#0',
                                'src': {'MUL': {'tgt': '#1', 'src': '#2'}}}}}},
       {'RET': {'tgt': '*a'}}]],
     [{'LOC': {'tgt': '*mul_constant_constant'}},
